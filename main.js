// starts const
let attackAmount = Math.floor(Math.random() * 20);
let magicAmount = Math.floor(Math.random() * 20);
let recovery= Math.floor(Math.random() * 10);
let addMagic= Math.floor(Math.random() * 7)
